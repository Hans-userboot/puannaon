...
API_ID = int(os.environ.get("API_ID", "12749571"))
API_HASH = os.environ.get("API_HASH", "eaae2f49b39e76e832d4921e00c21d1a")

CHANNEL_DB = int(os.environ.get("CHANNEL_DB", "-1001942557641"))
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://jnujsium:JwRYDLWg6THZdE93f0dRJrjXgnzIq-O2@satao.db.elephantsql.com/jnujsium")

RESTRICT = strtobool(os.environ.get("RESTRICT", "True"))

FORCE_SUB_1 = int(os.environ.get("FORCE_SUB_1", "-1001957259969"))
...
try:
    ADMINS = [int(x) for x in (os.environ.get("ADMINS", "5178772086 5943200597 5437750170 2122230923").split())]
except ValueError:
